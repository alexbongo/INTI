	...
	<nav class="navbar navbar-default navbar-fixed-top topnav"
		...
		<div class="container topnav">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand topnav" href="#">Gestionnaire de banque
					RAN</a>
			</div>
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="#about">Groupes</a></li>
					<li><a href="#services">Comptes</a></li>
					<li><a href="#contact">Opérations</a></li>
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown" role="button" aria-haspopup="true"
						aria-expanded="false">Banques<span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="#">Banque 1</a></li>
							<li role="separator" class="divider"></li>
							<li><a href="#">Banque 2</a></li>
							<li role="separator" class="divider"></li>
							<li><a href="#">Banque 3</a></li>
						</ul></li>
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown" role="button" aria-haspopup="true"
