...
<li><a href="#Accueille">Accueille</a></li>
...
<input type="text" class="form-control" placeholder="Preom">
<input type="date" name="anniversaire" class="form-control"
placeholder="Date de Naissance"> <input type="text"
class="form-control" placeholder="Code Postal">
<select class="form-control"  name="choixid"  id="choix" >
                            <option disabled selected>Employe</option>
                            <c:forEach items="${listeClient}" var="et">
                                <option value="${et.id}">${et.id}</option>
                            </c:forEach>
                        </select> 
<br>
...
<li><a href="#about">Ajouter Client</a></li>
<li class="footer-menu-divider">&sdot;</li>
<li><a href="#services">Supprimer</a></li>
<li class="footer-menu-divider">&sdot;</li>
<li><a href="#contact">Modifier Client</a></li>
<li class="footer-menu-divider">&sdot;</li>
<li><a href="#Recuperer">Récupérer Client</a></li>
