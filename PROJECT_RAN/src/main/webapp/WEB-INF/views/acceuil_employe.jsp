...
<body>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="intro-message">
						<h1>Accès employé du Gestionnaire de banque RAN</h1>
  ...
  <div  class="col-lg-4 col-md-4 col-sm-6">
    ...
    <div class="circular"><img class="img-circle" src="<%=request.getContextPath()%>/resources/img/client.jpg"  alt="Flower" ></div>
      <div><h2>Gestion des clients</h2></div>
      <div><span></span></div>
      </a>
  </div>
  <div  class="col-lg-4 col-md-4 col-sm-6">
    ...
    <br><div class="circular"><img class="img-circle" src="<%=request.getContextPath()%>/resources/img/compte.jpg" alt="Flower" ></div>
      <br><div><h2>Gestion des comptes</h2></div>
      <div><span></span></div>
      </a>
  </div>
  <div  class="col-lg-4 col-md-4 col-sm-6">
    ...
    <div class="circular"><img class="img-circle" src="<%=request.getContextPath()%>/resources/img/operation.jpg" alt="Flower" ></div>
      <div><h2>Gestion des operations</h2></div>
      <div><span></span></div>
      </a>
  </div>
					</div>
