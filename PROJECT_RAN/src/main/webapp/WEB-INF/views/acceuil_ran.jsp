...
<body>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a href="#employe" class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li role="separator" class="divider"></li>
							<li><a href="<%=request.getContextPath()%>/j_spring_security_logout">Déconnexion</a></li>
						</ul></li>
				</ul>
			</div>
			<!-- /.navbar-collapse -->
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="intro-message">
						...
						<h3>Gestion de compte client pour les employés de 3 banques</h3>
  ...
  <div  class="col-lg-3 col-md-4 col-sm-6">
  	 <a href="<%=request.getContextPath()%>/Client">
  ...
  <div  class="col-lg-3 col-md-4 col-sm-6">
  	 <a href="<%=request.getContextPath()%>/Compte">
    <br><div class="circular"><img class="img-circle" src="<%=request.getContextPath()%>/resources/img/compte.jpg" alt="Flower" ></div>
      <br><div><h2>Comptes</h2></div>
      <div><span></span></div>
      </a>
  </div>
  <div  class="col-lg-3 col-md-4 col-sm-6">
  	 <a href="<%=request.getContextPath()%>/op_ran">
			...
			<div class="row">
				<div class="col-lg-4 col-sm-6">
					...
					<p class="lead">
						...
						la banque, qui rassemble l'ensemble des activités de conseil, 
						d'intermédiation et d'exécution ayant trait aux opérations dites 
						de haut de bilan (introduction en Bourse, émission de dette, 
						fusion/acquisition) de grands clients corporate 
						(entreprises, investisseurs, mais aussi états).
					</p>
				</div>
				<div class="col-lg-4 col-sm-6">
					<hr class="section-heading-spacer">
					...
					<p class="lead">
						Une banque de financement est une banque, ou le département 
						d'une banque, dont l'activité d'octroi de crédit repose sur 
						l'accompagnement des grandes entreprises, investisseurs 
						institutionnels, collectivités territoriales et états dans 
						leurs opérations financières importantes et complexes, 
				...
				<div class="col-lg-4 col-sm-6">
					...
					<div class="clearfix"></div>
					<h2 class="section-heading">
						ALSAFADI Limited Bank:<br> Banque coopérative
					</h2>
					<p class="lead">
						Une coopérative de crédit, ou banque mutualiste1 est une banque 
						coopérative, c'est-à-dire une entité dans laquelle les sociétaires 
						ont la double-qualité d'usagers (clients déposants ou emprunteurs) 
						et de propriétaires (participant à la gouvernance).
					</p>
				</div>
			</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-5 col-lg-offset-1 col-sm-push-6  col-sm-6">
					...
					<div class="clearfix"></div>
					<h2 class="section-heading">
						Employés<br>du gestionnaire RAN
					</h2>
					<p class="lead">
						Les'employés du gestionnaire RAN peuvent effectuer des créations de
						 compte pour des clients dans leur banque respective.
						 Ils sont aussi habilité à effectuer des opérations sur les comptes de leur client.
					</p>
				</div>
				<div class="col-lg-5 col-sm-pull-6  col-sm-6">
				<div class="circular">
				<a href="<%=request.getContextPath()%>/ac_employe">
					<img class="img-responsive"
						src="<%=request.getContextPath()%>/resources/img/employe.jpg" alt="">
						<div><h2>Accès Employé</h2></div>
				</a>
				</div> </div>
			</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-5 col-sm-6">
					...
					<div class="clearfix"></div>
					<h2 class="section-heading">
						Administrateurs<br>du gestionnaire RAN
					</h2>
					<p class="lead">
						Les administrateurs du gestionnaire RAN sont des employés particuliers
						qui détiennent certains droits d'écriture.
						 Ils ont par exemple la possibilité d'ajouter de nouveaux employés dans 
						 la base de donnée, mais aussi de gérer les groupes d'employé.
					 
					</p>
				</div>
				<div class="col-lg-5 col-lg-offset-2 col-sm-6">
				<div class="circular">
				<a href="<%=request.getContextPath()%>/ac_admin">
					<img class="img-responsive"
						src="<%=request.getContextPath()%>/resources/img/administrateur.jpg"
						alt="">
						<div><h2>Accès Administrateur</h2></div>
				</a>		
				</div></div>
			</div>
